-- ============================================================
-- TryoutKu - Supabase Database Schema
...
-- ============================================================
-- SEED DATA - Contoh Tryout
-- ============================================================
INSERT INTO tryouts (title, description, mata_pelajaran, jenjang, kelas, durasi_menit, jumlah_soal, is_active, is_free)
VALUES
  ('Tryout Matematika SMA Kelas 10 - Aljabar', 'Latihan soal aljabar dasar untuk kelas 10 SMA. Mencakup persamaan linear, kuadrat, dan fungsi.', 'Matematika', 'SMA', '{10}', 90, 0, TRUE, TRUE),
  ('Tryout Bahasa Indonesia SMA - Teks Narasi', 'Latihan soal teks narasi dan deskripsi untuk persiapan ujian.', 'Bahasa Indonesia', 'SMA', '{10,11}', 60, 0, TRUE, TRUE),
  ...
  ('Tryout IPA SMP Kelas 7 - Makhluk Hidup', 'Soal-soal IPA tentang ciri-ciri makhluk hidup dan klasifikasi.', 'IPA', 'SMP', '{7}', 60, 0, TRUE, TRUE),
  ('Tryout Matematika SD Kelas 6 - Persiapan Ujian', 'Soal gabungan matematika SD kelas 6 untuk persiapan ujian akhir.', 'Matematika', 'SD', '{6}', 60, 0, TRUE, TRUE)
